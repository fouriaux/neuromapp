...
extern "C" int configure (int argc, char** argv){
   t     = (double*) storage_get (argv[0],   nullptr, nullptr, nullptr); // t must exist
   I     = (double*) storage_get (argv[1],   nullptr, nullptr, nullptr); // I must exist
...
extern "C" void help () {
    std::cout << "Passive membrane" << std::endl;
}
